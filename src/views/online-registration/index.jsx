...
import { uploadBatchConferees, getOnlineRegStatus } from '../Query';
...
const OnlineRegistration = () => {
    ...
    const handleSubmitAll = async (e) => {
        ...
        try {
            ...
            console.log('Submitting online batch:', batchData); // Debug log
        ...
        <Box sx={{ 
            ...
            <Box sx={{
                ...
                <Typography variant="h6" sx={{ 
                    ...
                    Loading Online Registration Form...
                </Typography>
            </Box>
        </Box>
    );
